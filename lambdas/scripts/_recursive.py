...
FIB = Y(
    lambda f: lambda n: LTE(n)(TWO)(lambda _: ONE)(
...
# more arithmetic
DIV = Y(
    lambda f: lambda a: lambda b: LT(a)(b)(lambda _: ZERO)(
        lambda _: INC(f(SUB(a)(b))(b))
    )(ZERO)
)
MOD = Y(
    lambda f: lambda a: lambda b: LT(a)(b)(lambda _: a)(lambda _: f(SUB(a)(b))(b))(ZERO)
)
